...
var X,Y,result;
class BackwardH1 extends Component {
  constructor(props){
    super(props);
    ...
    this.BackwardH1=this.BackwardH1.bind(this);
  }
  clear(event){
  ...
  BackwardH1(event){
    ...
    switch (d) {
            case 1:
                result = (func(x) - func(x-(1*h))) / Math.pow(h, d);
                break;
            case 2:
                result = (func(x) - 2*func(x-(1*h)) + func(x-(2*h))) / Math.pow(h, d);
                break;
            case 3:
                result = (func(x) - 3*func(x-(1*h)) + 3*func(x-(2*h)) - func(x-(3*h))) / Math.pow(h, d);
                break;
            case 4:
                result = (func(x) - 4*func(x-(1*h)) + 6*func(x-(2*h)) - 4*func(x-(3*h)) + func(x-(4*h))) / Math.pow(h, d) ;
                break;
            default:
                console.log("Error");
        }
