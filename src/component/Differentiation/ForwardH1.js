...
var X,Y,result;
class ForwardH1 extends Component {
  constructor(props){
    super(props);
    ...
    this.ForwardH1=this.ForwardH1.bind(this);
  }
  clear(event){
  ...
  ForwardH1(event){
    ...
    switch (d) {
            case 1:
                result = (func(x+(1*h)) - func(x)) / Math.pow(h, d);;
                break;
            case 2:
                result = (func(x+(2*h)) - 2*func(x+(1*h)) + func(x)) / Math.pow(h, d);
                break;
            case 3:
                result = (func(x+(3*h)) - 3*func(x+(2*h)) + 3*func(x+(1*h)) - func(x)) / Math.pow(h, d);
                break;
            case 4:
                result = (func(x+(4*h)) - 4*func(x+(3*h)) + 6*func(x+(2*h)) - 4*func(x+(1*h)) + func(x)) / Math.pow(h, d) ;
                break;
            default:
                console.log("Error");
        }
