        ...
        <div className="columns has-background-black">
                    ...
                    <div className="column is-10 is-custom">
                        ...
                        <div className="field has-addons">
                            ...
                            <p className="control">
                                <input className="input is-primary is-large" name="N" type="number" style={{width:"100vh"}} value={this.state.N} onChange={this.handleChange} min="2" max="10" placeholder="Enter Number of X" />
                            </p>
                        </div>
                        <br/>
                        <div className="field has-addons">
                            ...
                            <p className="control">
                                <input className="input is-primary is-large" name="M" type="number" style={{width:"100vh"}} value={this.state.M} onChange={this.handleChange} min="2" max="10" placeholder="Enter Number of Rows" />
                            </p>
                        </div>
                        <br/>
                        <div className="field has-addons">
                        ...
                        {(this.state.showMatrix)&&
                          <div id="M" className="box has-background-dark">
                              <h1 className="title is-1 has-text-white"><strong>Enter Data values</strong></h1>
                              <hr className="is-divider"/>
                                  <div>
                                      <strong className="title is-3 has-text-white">Enter Data values :</strong>
                                      <br/><br/>
                                      <div>{MatrixInput}</div>
                                  </div><br/><br/>
                              <div className="field has-addons">
                    ...
                    {(this.state.showOutput)&&
                      <div id="O" className="box has-background-dark">
                          ...
                          <br/>
                          <h2 className="title is-2 has-text-white"><strong>Sr = {Sr}</strong></h2>
                          <h2 className="title is-2 has-text-white"><strong>SYX = {SYX}</strong></h2>
                          <br/>
                      </div>
                    }
                  </div>
