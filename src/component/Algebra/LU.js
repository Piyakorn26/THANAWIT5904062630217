...
var MatrixA=[],MatrixB=[],Output=[],A=[],B=[],C=0,Decompose;
                    ...
                    <div className="column is-10 is-custom">
                        ...
                        {(this.state.showMatrix)&&
                          <div id="M" className="box has-background-dark">
                              ...
                              <div className="field has-addons">
                                  <div className="control">
                                      <button className="button is-success is-rounded" onClick={()=>this.LU(this.state.N)}>  Submit  </button>
                                  </div>
                              </div>
                          </div>
                        }
