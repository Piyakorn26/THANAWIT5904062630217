  ...
  createMatrix(n) {
    ...
    MatrixC=[];
        for (var i=1 ; i<=n ; i++) {
            ...
            id={"b"+i} key={"b"+i}
            placeholder={"b"+i} />)
            MatrixC.push(<InputNumber style={{
                width: "10%",
                height: "40%",
                fontSize: "18px",
                marginInlineEnd: "5%",
                          ...
                          <div id="M" className="box has-background-dark">
                              ...
                              <hr className="is-divider"/>
                                  <div>
                                      ...
                                      <div>{MatrixB}</div>
                                      <br/><br/>
                                      <strong className="title is-3 has-text-white">Enter X values :</strong>
                                      <br/><br/>
                                      <div>{MatrixC}</div>
                                  </div><br/><br/>
                              <div className="field has-addons">
                                  <div className="control">
                                      <button className="button is-success is-rounded" onClick={()=>this.Jacobi(this.state.N)}>  Submit  </button>
                                  </div>
                              </div>
                          </div>
                        }
