                  ...
                  <div className="column is-10 is-custom">
                      <form id="F" className="box has-background-dark" onSubmit={this.handleSubmit}>
                          ...
                          <div className="field has-addons">
                              ...
                              <p className="control">
                                  <input className="input is-primary is-large" name="x0" type="number" style={{width:"110vh"}} step="any" value={this.state.x0} onChange={this.handleChange} placeholder="Enter X0"/>
                              </p>
                          </div>
                          <div className="field has-addons">
                              <p className="control">
                              ...
                              <p className="control">
                                  <input className="input is-primary is-large" name="x1" type="number" style={{width:"110vh"}} step="any" value={this.state.x1} onChange={this.handleChange} placeholder="Enter X1" />
                              </p>
                          </div><br/>
                          <div className="field has-addons">
