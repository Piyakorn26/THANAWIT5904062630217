                  ...
                  <div className="column is-10 is-custom">
                      <form id="F" className="box has-background-dark" onSubmit={this.handleSubmit}>
                          ...
                          <div className="field has-addons">
                              ...
                              <p className="control">
                                  <input className="input is-primary is-large" name="E" type="text" style={{width:"100vh"}} value={this.state.E} onChange={this.handleChange} placeholder="Enter F(x)" />
                              </p>
                          </div>
                          <div className="field has-addons">
                              <p className="control">
                              ...
                              <p className="control">
                                  <input className="input is-primary is-large" name="E2" type="text" style={{width:"100vh"}} value={this.state.E2} onChange={this.handleChange} placeholder="Enter F'(x)" />
                              </p>
                          </div>
                          <div className="field has-addons">
                              <p className="control">
                              ...
                              <p className="control">
                                  <input className="input is-primary is-large" name="x" type="number" style={{width:"110vh"}} step="any" value={this.state.x} onChange={this.handleChange} placeholder="Enter X0"/>
                              </p>
                          </div>
                          <div className="field has-addons">
