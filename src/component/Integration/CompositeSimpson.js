...
class CompositeSimpson extends Component {
  ...
  CompositeSimpson(event){
    ...
    error=parseInt(((integral-I)/integral)*100);
                  ...
                  <div className="column is-10 is-custom">
                      <form id="F" className="box has-background-dark" onSubmit={this.handleSubmit}>
                          ...
                          <div className="field has-addons">
                              ...
                              <p className="control">
                                  <input className="input is-primary is-large" name="a" type="number" style={{width:"110vh"}} step="any" value={this.state.a} onChange={this.handleChange} placeholder="Enter a"/>
                              </p>
                          </div>
                          <div className="field has-addons">
                              <p className="control">
                              ...
                              <p className="control">
                                  <input className="input is-primary is-large" name="b" type="number" style={{width:"110vh"}} step="any" value={this.state.b} onChange={this.handleChange} placeholder="Enter b" />
                              </p>
                          </div>
                          <div className="field has-addons">
                              <p className="control">
                              ...
                              <p className="control">
                                  <input className="input is-primary is-large" name="n" type="number" style={{width:"110vh"}} value={this.state.n} onChange={this.handleChange} placeholder="Enter n"/>
                              </p>
                          </div><br/>
                          <div className="field has-addons">
