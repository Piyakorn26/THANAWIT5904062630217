...
import Euler from './ODE/Euler.js';
import Heun from './ODE/Heun.js';
import MEuler from './ODE/MEuler.js';
  ...
  render() {
    const container=()=>{
      switch (this.state.title) {
        ...
        case "Euler's method": return <Euler title={this.state.title}/>;
        case "Heun's method": return <Heun title={this.state.title}/>;
        case "Modified Euler's method": return <MEuler title={this.state.title}/>;
    ...
    return (
      <div>
          ...
          {(this.state.title!=="Welcome")&&<Banner title={this.state.title}/>}
          <div>{container()}</div>
